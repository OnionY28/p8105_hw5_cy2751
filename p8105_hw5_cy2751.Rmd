...
There is one row that mistakenly write city `Tulsa` belongs to state `AL`, which should belongs to `OK`, so we remove this row for inprecision reason.
...
This dataset about homicides in 50 large U.S. cities has `r nrow(homicide)` rows and `r ncol(homicide)+1` columns. It has more than 52000 criminal homicides over the past decade. And it includes the date of the cases，basic information about the suspect，location of the cases and whether the arrest has been made.
